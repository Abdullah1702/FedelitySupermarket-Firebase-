...
<body>
    ...
    <script  type="module" src="manage/transaction-page.js"></script>
    <!-- ======= Header ======= -->
    <header id="header" class="fixed-top header-inner-pages">
        <div class="container d-flex align-items-center">

            <h1 class="logo me-auto"><a href="index.html">Fidelity Supermarket</a></h1>
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a href="inner-page.php"><i class="fa fa-user-circle-o fa-3x icon" aria-hidden="true"></i> Area
                            personale</a></li>
                    <li><a href="transaction-page.php" class="active"><i class="zmdi zmdi-book icon"></i>Transazione</a>
                    </li>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary" id="data">
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-sm-3">
                                    <h6 class="mb-0">Prezzo Totale</h6>
                                </div>
                                <div class="col-sm-9 text-secondary" id="prezzoFinale">
                                </div>
                            </div>
